...
class UNet16(nn.Module):
    def __init__(self, num_classes=1, num_filters=32, weights=False, is_deconv=False):
        """
        :param num_classes:
        :param num_filters:
        :param weights:
        ...
        #print(torchvision.models.vgg16(weights=weights))
    ...
    def forward(self, x):
        ...
        print(f"conv5 size: ",conv5.size())
        print(f"center size: ",center.size())
        print(f"dec5 size: ",dec5.size())
        print(f"dec4 size: ",dec4.size())
        print(f"dec3 size: ",dec3.size())
...
class UNetResNet(nn.Module):
    ...
    def __init__(self, encoder_depth, num_classes, num_filters=32, dropout_2d=0.2,
        ...
        if encoder_depth == 34:
            ...
            self.encoder = torchvision.models.resnet101(weights=weights)
            bottom_channel_nr = 2048
        elif encoder_depth == 152:
            self.encoder = torchvision.models.resnet152(weights=weights)
            bottom_channel_nr = 2048
        else:
