...
if __name__ == '__main__':
    ...
    parser.add_argument('-img_path', nargs='+', type=str, help='input image paths')
    parser.add_argument('-mask_path', nargs='+', type=str, help='input mask paths')
    ...
    parser.add_argument('-out_viz_dir', type=str, required=False, help='visualization output dir')
    parser.add_argument('-out_pred_dir', type=str, required=False,  help='prediction output dir')
    ...
    if args.mask_path != []:
        dataloader = [list(i) for i in zip(args.img_path, args.mask_path)]
        with_mask(dataloader)
    else:
        dataloader = args.img_path
        without_mask(dataloader)
